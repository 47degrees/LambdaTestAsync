...
scmInfo := Some(ScmInfo(url("https://github.com/47deg/LambdaTestAsync"), "https://github.com/47deg/LambdaTestAsync.git"))
...
homepage := Some(url("https://github.com/47deg/LambdaTestExpect"))

scmInfo := Some(ScmInfo(url("https://github.com/47deg/LambdaTestExpect"), "scm:git@github.com:47deg/LambdaTestExpect.git"))
